...
export const SHOPIFY_STORE_PERMANENT_DOMAIN = "dream-shop-creator-h6866-r1m0m4dx.myshopify.com";
export const SHOPIFY_STOREFRONT_URL = `https://${SHOPIFY_STORE_PERMANENT_DOMAIN}/api/${SHOPIFY_API_VERSION}/graphql.json`;
export const SHOPIFY_STOREFRONT_TOKEN = "0362f40bbb61097e59e65a12415a54ee";
...
export async function storefrontApiRequest(query: string, variables: Record<string, unknown> = {}) {
  ...
  if (response.status === 402) {
    ...
    toast.error("Shopify: pago requerido", {
      description:
        "El acceso a la API de Shopify requiere un plan activo. Visita admin.shopify.com para actualizarlo.",
    });
    return;
  }
